...
- ZÉRO CARTE SÉRIE GRILLE IDENTIQUE : Ne répète pas de grilles de cartes mécaniques (icône + gros chiffre + petit label) sauf si le contenu est strictly une liste chiffrée.
