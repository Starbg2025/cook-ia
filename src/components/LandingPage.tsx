...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnter }) => {
  ...
  const backgroundValue = useTransform(
    ...
    [0, 0.3, 0.6, 1],
    [
      "radial-gradient(circle at 50% 0%, #1a1a1a 0%, #050a12 70%)", 
      "radial-gradient(circle at 50% 0%, #050a12 0%, #000000 100%)", 
      "radial-gradient(circle at 50% 0%, #000000 0%, #050a12 100%)",
      "radial-gradient(circle at 50% 100%, #1a0f00 0%, #000000 100%)"
    ]
  );
  ...
  return (
    <div ref={containerRef} className="relative min-h-[700vh] overflow-hidden bg-abyssal-deep text-white font-sans selection:bg-orange-primary selection:text-white">
      {/* Dynamic Background */}
      <motion.div 
      ...
      {/* Custom Cursor */}
      <div 
        className="fixed w-12 h-12 border border-white/10 rounded-full z-50 pointer-events-none bg-radial-[at_30%_30%] from-white/5 to-transparent backdrop-blur-[1px] hidden md:block"
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 p-6 flex justify-between items-center backdrop-blur-xl border-b border-white/5 bg-black/5">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-orange-primary rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(255,107,0,0.5)]">
            <Zap size={22} className="text-white fill-white" />
          </div>
          <span className="font-display font-black text-xl tracking-tighter text-white">COOK IA</span>
        </div>
        <div className="hidden md:flex items-center gap-8">
          <a href="#vision" className="text-xs font-bold uppercase tracking-widest text-white/50 hover:text-orange-primary transition-colors">Vision</a>
          <a href="#agents" className="text-xs font-bold uppercase tracking-widest text-white/50 hover:text-orange-primary transition-colors">Experts</a>
          <a href="#tech" className="text-xs font-bold uppercase tracking-widest text-white/50 hover:text-orange-primary transition-colors">Tech</a>
        </div>
        <button 
          onClick={onEnter}
          className="group relative px-6 py-2.5 rounded-full bg-orange-primary text-white text-xs font-black uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,107,0,0.3)]"
        >
          Lancer l'IA
        </button>
      </nav>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center z-10 px-4">
        ...
        >
          <div className="absolute inset-0 bg-orange-primary rounded-full blur-[100px] opacity-20 animate-pulse" />
          <div className="w-36 h-36 bg-orange-primary rounded-[48px] flex items-center justify-center shadow-[0_0_100px_rgba(255,107,0,0.5)] relative z-10">
            <Zap size={72} className="text-white fill-white" />
          </div>
        </motion.div>

        <h1 className="font-display text-7xl md:text-[8rem] mb-6 text-center tracking-tighter leading-none relative">
          {["C","O","O","K"," ","I","A"].map((char, i) => (
            <motion.span 
              key={i}
              className="inline-block hover:text-orange-primary transition-colors cursor-default"
              animate={{ 
                y: [0, -15, 0],
                rotate: [0, 2, 0]
              }}
        ...
        <p className="max-w-3xl text-center text-xl md:text-3xl text-white/80 font-medium mb-16 px-4 leading-normal font-sans">
        ...
        >
          <button 
            onClick={onEnter}
            className="group relative px-12 py-6 bg-gradient-to-r from-orange-primary to-[#FF8C00] rounded-2xl font-display font-black text-base md:text-lg text-white uppercase tracking-[0.2em] shadow-[0_0_50px_rgba(255,107,0,0.4)] hover:shadow-[0_0_80px_rgba(255,107,0,0.6)] transition-all hover:-translate-y-1 active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <motion.div 
              ...
              className="group relative p-10 rounded-[48px] border border-white/5 bg-white/[0.02] backdrop-blur-3xl hover:bg-white/[0.05] transition-all hover:border-orange-primary/20"
            >
              <div className="w-16 h-16 rounded-2xl bg-orange-primary/10 flex items-center justify-center text-orange-primary mb-10 group-hover:scale-110 transition-transform shadow-[0_0_30px_rgba(255,107,0,0.1)]">
                {feat.icon}
              </div>
              <h3 className="font-display text-xl mb-4 group-hover:text-orange-primary transition-colors">{feat.title}</h3>
      ...
      <section id="tech" className="relative min-h-screen py-32 z-10 flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 pointer-events-none opacity-20">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] aspect-square border-2 border-dashed border-orange-primary/10 rounded-full animate-[spin_60s_linear_infinite]" />
          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
            {["React 18", "TypeScript", "Node.js", "Express", "Supabase", "Firestore", "Tailwind CSS", "Vite", "Gemini 1.5 Pro", "Framer Motion"].map((tech, i) => (
              <motion.div 
                ...
                className="px-8 py-4 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-sm font-bold tracking-wider hover:border-orange-primary hover:text-orange-primary transition-colors"
              >
                {tech}
              </motion.div>
            ))}
      ...
      <section className="relative min-h-screen py-32 z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-orange-primary/20 blur-[120px] rounded-full animate-pulse" />
            <motion.div 
            ...
            >
              <div className="flex items-center gap-4 mb-12">
                <div className="w-12 h-12 rounded-full bg-orange-primary flex items-center justify-center">
              ...
              <div className="space-y-8">
                <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
                  <motion.div 
                    ...
                    className="h-full bg-orange-primary shadow-[0_0_15px_rgba(255,107,0,0.8)]" 
                  />
                </div>
                <div className="flex justify-between text-xs font-mono text-white/40">
                  <span>VITESSE DE CODAGE</span>
                  <span className="text-orange-primary uppercase tracking-widest text-[10px] font-black">98.4% PLUS RAPIDE</span>
                </div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center z-10 overflow-hidden">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[200%] h-[60%] bg-radial-[at_50%_100%] from-orange-primary/10 to-transparent blur-[150px] pointer-events-none" />
        ...
        >
          <Sparkles className="text-orange-primary mb-12 mx-auto animate-pulse" size={64} />
          <h2 className="font-display text-6xl md:text-[8rem] mb-12 tracking-tighter leading-none">VOTRE AVENTURE<br/><span className="text-orange-primary">COMMENCE ICI.</span></h2>
          
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <button 
              onClick={onEnter}
              className="group relative px-20 py-8 bg-orange-primary text-white font-display font-black text-xl uppercase tracking-[0.2em] rounded-3xl hover:bg-orange-600 hover:scale-105 transition-all shadow-[0_0_80px_rgba(255,107,0,0.15)] flex items-center gap-4"
            >
      ...
      <footer className="relative z-10 py-16 border-t border-white/5 bg-black/40 backdrop-blur-3xl">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex gap-12 text-[10px] font-bold uppercase tracking-widest text-white/30">
            ...
            <a href="https://discord.gg/Pc6reuApRF" className="hover:text-orange-primary transition-colors">Support</a>
          </div>
